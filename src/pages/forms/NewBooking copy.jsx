...
const NewBooking = () => {
  ...
  const buildStudentPayload = () => {
    ...
    const addStudent = (name) => {
      ...
      if (!first_name || !last_name) {
        alert("Please provide both first and last names for all new students.");
  ...
  // const programOptions = [
  //   { value: "Key Stage 1", label: "Primary (1–6)" },
  //   { value: "Key Stage 2", label: "Secondary (7–11)" },
  //   { value: "Key Stage 3", label: "Senior (12–13)" },
  // ];
  ...
  //             return Array.isArray(levels) && levels.includes(Number(formData.programOne));
  //           } catch {
  //             return false;
  //           }
  //         })
              ...
              <div className="mb-2 ">
                ...
                <Select
                  ...
                  value={filteredProgramTwoOptions.find(
                    (opt) =>
                      opt.value.toString() === formData.program.toString()
                  )}
          ...
          {studyType === "no" && (
            <div className="space-y-4">
              ...
              <Select
                ...
                value={filteredProgramTwoOptionsStudent1.find(
                  (opt) =>
                    opt.value.toString() ===
                    formData.student1.program.toString()
                )}
              ...
              {formData.students === "2" && (
                <div className="space-y-4">
                  ...
                  <Select
                    ...
                    value={filteredProgramTwoOptionsStudent2.find(
                      (opt) =>
                        opt.value.toString() ===
                        formData.student2.program.toString()
                    )}
          ...
          {!studyType && (
            <>
              ...
              <Select
                options={filteredProgramTwoOptions}
                value={filteredProgramTwoOptions.find(
                  (opt) => opt.value.toString() === formData.program.toString()
                )}
                onChange={(selected) => handleProgramTwoChange(selected)}
                placeholder="Select Year"
                isDisabled={
